...
ClusterManagerPtr ValidationClusterManagerFactory::clusterManagerFromProto(
  ...
  return std::make_unique<ValidationClusterManager>(
      bootstrap, *this, stats_, load_report_stats_store_, tls_, runtime_, random_, local_info_, log_manager_,
...
ValidationClusterManager::ValidationClusterManager(
    ...
    Stats::Store& stats,
    Stats::StoreRootPtr& load_stats_store_root,
    ...
    : ClusterManagerImpl(bootstrap, factory, stats, load_stats_store_root, tls, runtime, random, local_info, log_manager,
